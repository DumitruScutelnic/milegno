        ...
        function y() {
          v(h),
            ...
            document.body.attributes.style &&
              (document.body.attributes.style.value = g),
            i(f.element, "smart-form-closed");
        }
        function v(e) {
        ...
        function w() {
          ...
          e.redirectURL && s(e.redirectURL)
            ...
            : (i(f.element, "smart-form-sent"),
              m({ status: "success", title: e.title, message: e.message }),
              f.reset());
        }
        function k() {
          var e =
          ...
          i(f.element, "smart-form-error"),
            m({ status: "error", title: e.title, message: e.message });
        }
        a(p, {
          position: "fixed",
          top: "50%",
              ...
              e.preventDefault(),
                (f = new r(e.target, {
                  ...
                  beforeSend: function (e) {
                    return m(Object.assign({ status: "loading" }, e));
                  },
                })),
                (function () {
                  var e = new URL(l),
                    t = new URLSearchParams(e.search.slice(1)),
                    n = f.getMessage("close");
                  t.append("closeBtnText", n),
                    (e.search = t.toString()),
                    (p.src = e.toString());
                  var r = document.body;
                  (g = r.attributes.style ? r.attributes.style.value : ""),
                    a(r, d, !0),
                    r.appendChild(p),
                    r.appendChild(h);
                })();
